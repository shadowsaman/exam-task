...
// @Param offset query int false "offset"
// @Param limit query int false "limit"
// @Success 200 {object} models.GetListInvestorResponseFoyda "GetInvestorListBody"
// @Response 400 {object} string "Invalid Argumant"
// @Failure 500 {object} string "Server error"
func (h *Handler) GetListInvestorFoyda(c *gin.Context) {
	var (
		err       error
		offset    int
		limit     int
	...
	res, err := h.storage.Investor().GetListFoyda(context.Background(), &models.GetListInvestorRequest{
		Offset: int64(offset),
		Limit:  int64(limit),
	})
