...
func (h *Handler) UpdateOrder(c *gin.Context) {
	...
	err = h.storage.Order().Update(context.Background(), &models.UpdateOrder{
		Id:         order.Id,
		CarId:      order.CarId,
...
// @Produce json
// @Param id path string true "id"
// @Param Order body models.UpdateStatusSwag true "UpdateStatusRequestBody"
// @Success 202 {object} models.Order "UpdateStatusBody"
// @Response 400 {object} string "Invalid Argumant"
// @Failure 500 {object} string "Server error"
func (h *Handler) UpdateOrderStatus(c *gin.Context) {

	var order models.UpdateStatus
	...
	err = h.storage.Order().UpdateStatus(context.Background(), &models.UpdateStatus{
		Id:     order.Id,
		Status: order.Status,
	})
